...
suite('generateSnapshotScript({baseDirPath, mainPath})', () => {
  ...
  test('row translation', async () => {
    ...
    assert.deepEqual(snapshotResult.translateSnapshotRow(301), {relativePath: '../fixtures/module-1/index.js', row: 12})
    assert.deepEqual(snapshotResult.translateSnapshotRow(302), {relativePath: '<embedded>', row: 302})
    assert.deepEqual(snapshotResult.translateSnapshotRow(304), {relativePath: '../fixtures/module-1/dir/a.js', row: 0})
    assert.deepEqual(snapshotResult.translateSnapshotRow(312), {relativePath: '../fixtures/module-1/dir/a.js', row: 8})
    assert.deepEqual(snapshotResult.translateSnapshotRow(313), {relativePath: '<embedded>', row: 313})
    assert.deepEqual(snapshotResult.translateSnapshotRow(318), {relativePath: '../fixtures/module-1/node_modules/a/index.js', row: 0})
