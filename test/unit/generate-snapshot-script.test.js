...
suite('generateSnapshotScript({baseDirPath, mainPath})', () => {
  ...
  test('row translation', async () => {
    ...
    assert.deepEqual(snapshotResult.translateSnapshotRow(305), {relativePath: '../fixtures/module-1/dir/a.js', row: 0})
    assert.deepEqual(snapshotResult.translateSnapshotRow(314), {relativePath: '../fixtures/module-1/dir/a.js', row: 9})
    assert.deepEqual(snapshotResult.translateSnapshotRow(315), {relativePath: '<embedded>', row: 315})
    assert.deepEqual(snapshotResult.translateSnapshotRow(321), {relativePath: '../fixtures/module-1/node_modules/a/index.js', row: 0})
    assert.deepEqual(snapshotResult.translateSnapshotRow(322), {relativePath: '../fixtures/module-1/node_modules/a/index.js', row: 1})
